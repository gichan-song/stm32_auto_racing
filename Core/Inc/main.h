...
#define EchoL_GPIO_Port GPIOA
#define TrigL_Pin GPIO_PIN_6
#define TrigL_GPIO_Port GPIOA
#define TrigR_Pin GPIO_PIN_10
#define TrigR_GPIO_Port GPIOB
#define EchoC_Pin GPIO_PIN_7
#define EchoC_GPIO_Port GPIOC
#define EchoR_Pin GPIO_PIN_8
#define EchoR_GPIO_Port GPIOA
#define TrigC_Pin GPIO_PIN_9
